...
r = os.system("cp /nfs/scistore15/saricgrp/acorso/actin/treadmilling/chiral_800/files/configuration.txt " + gpath + "/configuration.txt")
...
pair_coeff          1 5 cosine/squared 1.00 1.00 1.00 wca
pair_coeff          2 5 cosine/squared 1.00 1.00 1.00 wca
pair_coeff          3 5 cosine/squared 1.00 1.00 1.00 wca
